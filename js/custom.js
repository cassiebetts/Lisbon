...
/* ================================  CONTACT PAGE  =================================== */
	...
	/* SET CONTACT FORM SUCCESS MESSAGE */
			...
			var successBoxColor = "f901ad"; // Background color for the success box

			var successBoxBorderStyle = "solid"; // Border Style  -  Example: solid, dotted, dashed, double

			var successBox_Border_Color = "f901ad"; // Border color for success box
...
/* ================================  SUBSCRIBE FORM  =================================== */
	...
	/* SET SUBSCRIBE FORM SUCCESS MESSAGE */
			...
			var sub_successBoxColor = "f901ad"; // Background color for the success box

			var sub_successBoxBorderStyle = "solid"; // Border Style  -  Example: solid, dotted, dashed, double

			var sub_successBox_Border_Color = "f901ad"; // Border color for success box
